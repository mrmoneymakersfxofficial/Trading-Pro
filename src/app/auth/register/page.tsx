      ...
      <div className="w-full max-w-md pt-16">
        ...
        <div className="p-8 rounded-2xl border border-zinc-800 bg-zinc-900/50">
          ...
          <p className="text-zinc-400 mb-6">
            Regístrate para obtener tu licencia y automatizar tu trading.
          </p>

          {/* Google OAuth */}
          <Button
            variant="outline"
            className="w-full h-11 border-zinc-700 bg-zinc-800 hover:bg-zinc-700 text-white rounded-xl mb-4"
          ...
          <div className="relative my-6">
            ...
            <div className="relative flex justify-center text-xs">
              <span className="px-3 bg-zinc-900 text-zinc-500">o</span>
            </div>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            <div>
              <Label htmlFor="name" className="text-zinc-300 mb-1.5 block text-sm">
                Nombre
              </Label>
            ...
            <div>
              <Label htmlFor="password" className="text-zinc-300 mb-1.5 block text-sm">
                Contraseña
              </Label>
              <div className="relative">
                ...
                <Input
                  ...
                  className="pl-10 pr-10 h-11 bg-zinc-800 border-zinc-700 text-white placeholder:text-zinc-500 rounded-xl focus:border-emerald-500/50 focus:ring-emerald-500/20"
                  required
                />
                <button
                  type="button"
            ...
            <div>
              <Label htmlFor="confirmPw" className="text-zinc-300 mb-1.5 block text-sm">
